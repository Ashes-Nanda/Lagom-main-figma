...
// Mental Health Platform specific enums
...
export enum Author {
  ...
  DR_MICHAEL = "Dr. Michael Chen",
  DR_EMILY = "Dr. Emily Rodriguez",
  DR_LISA = "Dr. Lisa Thompson",
  DR_JAMES = "Dr. James Wilson",
}
...
export type FilterOption = {
  name: FilterType | Status | Assignee | Labels | Priority | DueDate | Category | ResourceType | Duration | Author | Location | Cost;
...
const FilterIcon = ({
  ...
  type: FilterType | Status | Assignee | Labels | Priority | Category | ResourceType | Duration | Author | Location | Cost;
}) => {
  switch (type) {
    ...
    case Category.BURNOUT:
      return <Heart className="size-3.5 text-red-500" />;
    case Category.RESILIENCE:
      return <Brain className="size-3.5 text-blue-500" />;
    case Category.SLEEP:
      return <Clock className="size-3.5 text-purple-500" />;
    case Category.MINDFULNESS:
      return <Brain className="size-3.5 text-green-500" />;
    case Category.MEDITATION:
      return <Brain className="size-3.5 text-indigo-500" />;
    case Category.BREATHING:
      return <Heart className="size-3.5 text-pink-500" />;
    case Category.STORIES:
      return <BookOpen className="size-3.5 text-orange-500" />;
    ...
    case Author.VYSHNAVI:
      return <UserCircle className="size-3.5 text-purple-500" />;
    case Author.SHEHANI:
      return <UserCircle className="size-3.5 text-pink-500" />;
    case Author.DR_SARAH:
      return <UserCircle className="size-3.5 text-blue-500" />;
    case Author.DR_MICHAEL:
      return <UserCircle className="size-3.5 text-green-500" />;
    case Author.DR_EMILY:
      return <UserCircle className="size-3.5 text-orange-500" />;
    case Author.DR_LISA:
      return <UserCircle className="size-3.5 text-teal-500" />;
    case Author.DR_JAMES:
      return <UserCircle className="size-3.5 text-indigo-500" />;
    case Location.VIRTUAL:
      return <MapPin className="size-3.5 text-blue-500" />;
    case Location.CALIFORNIA:
      return <MapPin className="size-3.5 text-orange-500" />;
    case Location.CHICAGO:
      return <MapPin className="size-3.5 text-red-500" />;
    case Location.SAN_FRANCISCO:
      return <MapPin className="size-3.5 text-purple-500" />;
    case Cost.FREE:
      return <div className="bg-green-400 rounded-full size-2.5" />;
    case Cost.PAID:
      return <div className="bg-blue-400 rounded-full size-2.5" />;
...
// Mental Health Platform specific filter options
export const mentalHealthFilterOptions: FilterOption[][] = [
  [
    {
  ...
  [
    ...
    {
      name: FilterType.COST,
      icon: <FilterIcon type={FilterType.COST} />,
    },
  ],
];
...
export const resourceTypeFilterOptions: FilterOption[] = Object.values(ResourceType).map(
  (type) => ({
    name: type,
...
export const durationFilterOptions: FilterOption[] = Object.values(Duration).map(
  (duration) => ({
    name: duration,
    icon: <FilterIcon type={duration} />,
  })
);
...
export const locationFilterOptions: FilterOption[] = Object.values(Location).map(
  (location) => ({
    name: location,
    icon: <FilterIcon type={location} />,
  })
);

export const costFilterOptions: FilterOption[] = Object.values(Cost).map(
  (cost) => ({
    name: cost,
    icon: <FilterIcon type={cost} />,
  })
);
...
export const filterViewToFilterOptions: Record<FilterType, FilterOption[]> = {
  ...
  [FilterType.TYPE]: resourceTypeFilterOptions,
  [FilterType.DURATION]: durationFilterOptions,
  [FilterType.AUTHOR]: authorFilterOptions,
  [FilterType.LOCATION]: locationFilterOptions,
  [FilterType.COST]: costFilterOptions,
};
