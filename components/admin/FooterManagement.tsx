...
import { Plus, Edit, Trash2, ExternalLink, Instagram, Linkedin, Facebook, Twitter } from 'lucide-react';
...
export function FooterManagement() {
  const [footerContent, setFooterContent] = useState<FooterContent>({
    ...
    description: 'Creating safe trauma-informed spaces, by HCPs for HCPs, to seek mental health support, build institutional resilience, and transform care culture.',
    contactEmail: 'hello@being.lagom',
  ...
  const handleLinkSubmit = (e: React.FormEvent) => {
    ...
    if (editingLink) {
      setFooterLinks(footerLinks.map(l => 
        l.id === editingLink.id 
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage footer content, social links, and navigation</p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleContentUpdate('organizationName', e.target.value)}
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleContentUpdate('contactEmail', e.target.value)}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleContentUpdate('contactPhone', e.target.value)}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleContentUpdate('copyrightText', e.target.value)}
                  />
                </div>
              </div>
        ...
        <TabsContent value="social" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {socialLinks.map((social) => {
              ...
              return (
                <Card key={social.id} className={`${!social.isActive ? 'opacity-60' : ''}`}>
                  <CardContent className="p-4">
                    ...
                    <p className="text-xs text-gray-600 truncate">{social.url}</p>
                  </CardContent>
                </Card>
              );
            })}
        ...
        <TabsContent value="links" className="space-y-4">
          ...
          <div className="space-y-4">
            {linkCategories.map((category) => {
              const categoryLinks = footerLinks.filter(link => link.category === category.value);
              return (
                        ...
                        {categoryLinks.map((link) => (
                          <div key={link.id} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            <div className="flex-1">
                              <span className={`font-medium ${!link.isActive ? 'text-gray-500' : ''}`}>
                                {link.title}
                              </span>
          ...
          <form onSubmit={handleSocialSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) => setSocialFormData(prev => ({ ...prev, platform: e.target.value as SocialLink['platform'] }))}
          ...
          <form onSubmit={handleLinkSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={(e) => setLinkFormData(prev => ({ ...prev, category: e.target.value as FooterLink['category'] }))}
                className="w-full p-2 border rounded-md"
                required
              >
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setLinkFormData(prev => ({ ...prev, order: parseInt(e.target.value) || 1 }))}
                min="1"
              />
            </div>
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                onChange={(e) => setLinkFormData(prev => ({ ...prev, isActive: e.target.checked }))}
                className="rounded"
              />
